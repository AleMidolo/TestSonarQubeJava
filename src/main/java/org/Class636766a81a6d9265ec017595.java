...
public class Class636766a81a6d9265ec017595 {
    private byte[] data;
    private int size;

    public Class636766a81a6d9265ec017595() {
     ...
     */
    final Class636766a81a6d9265ec017595 put11(final int byteValue1, final int byteValue2) {
